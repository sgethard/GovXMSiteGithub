...
$global_layout_sidebar = apply_filters( 'egovt_get_layout', '' );
...
$global_width_site = apply_filters( 'egovt_width_site', '' );
$global_boxed_container_width = get_theme_mod( 'global_boxed_container_width', '1270' );
